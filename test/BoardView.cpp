...
constexpr std::size_t bpp_565 = 5 + 6 + 5;
...
TEST_CASE("BoardView RGB565 cvt", "[BoardView]") {
    ...
    // test case 3
    {
        ...
        constexpr std::array in = {'\xB8'_b, '\x80'_b, '\x50'_b};
    ...
    // test case 4
    {
        ...
        constexpr std::array in = {'\x23'_b, '\x7B'_b, '\x88'_b, '\x54'_b, '\xDB'_b, '\xA1'_b,
                                   '\x88'_b, '\x3C'_b, '\xB8'_b, '\xB8'_b, '\x9C'_b, '\xD0'_b};
        constexpr std::array expected_out = {'\x23'_b, '\xF1'_b, '\x56'_b, '\xF4'_b,
                                             '\x44'_b, '\xF7'_b, '\xBA'_b, '\xF4'_b};
        static_assert(expected_out.size() == in.size() / 3 * 2);
